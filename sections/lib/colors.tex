...
\definecolor{chapterdegradado@color}		{cmyk}{0.21,0.04,0,0.18}
\definecolor{chapterelipse@bg@color}	{cmyk}{0.33,0.07,0,0.18}
\definecolor{chapterelipse@color}		{cmyk}{0,0,0,0}
...
\definecolor{ej@bg@color}				{cmyk}{0.17,0.15,0,0.07}
\definecolor{ejtitle@bg@color}			{cmyk}{0.88,0.76,0,0.61}
\definecolor{ejtitle@color}				{cmyk}{0,0.04,0.73,0}
\definecolor{dem@border@color}			{cmyk}{0,0,0,1}
\definecolor{dem@bg@color}				{cmyk}{0,0,0,0}
\definecolor{actividadtitle@color}		{cmyk}{0.25,0.85,0,0.38}
\definecolor{actividadnum@color}		 	{cmyk}{0,0,0,0}
\definecolor{ejercicios@bg@color}		 	{cmyk}{0.17,0.07,0,0.12}
\definecolor{ejerciciotitle@bg@color}		{cmyk}{0.85,0.41,0,0.75}
\definecolor{ejerciciotitle@color}		{cmyk}{0,0,0,0}
\definecolor{ejercicionum@bg@color}		{cmyk}{0.85,0.41,0,0.75}
\definecolor{ejercicionum@color}			{cmyk}{0,0,0,0}
